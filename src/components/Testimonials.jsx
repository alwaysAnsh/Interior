...
const Testimonials = () => {
  return (
    ...
    <div class="container flex flex-col items-center justify-center w-full p-6 mx-auto mt-4 text-center xl:px-0">
        ...
        <p class="max-w-2xl py-4 text-lg leading-normal text-darkblue lg:text-xl xl:text-xl dark:text-gray-300">Testimonails is a great way to increase the brand trust and awareness. Use this section to highlight your popular customers.</p>
    </div>
