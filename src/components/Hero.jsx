...
import heroSection from '../assets/heross.png'
import chairs from '../assets/chairs.png'
import '../App.css'

const Hero = () => {
  return (
    <div className = 'z-10 relative flex flex-row items-center justify-center  overflow-hidden  bg-lightgreen h-[90vh]  ' >
        ...
        {/* <div className='flex flex-row items-center overflow-hidden justify-evenly' > */}
          ...
          <svg width="15px" height="10px" viewBox="0 0 13 10">
            ...
            <div>
            <img className=' md:h-[760px]   overflow-y-hidden' src={heroSection} alt="image containing furnitures and images of living rooms" />
            </div>
        {/* </div>   */}
