...
const Footer = () => {
  return (
    <footer className="bg-darkblue lg:grid lg:grid-cols-5 font-playfair text-white">
  <div className="relative block h-32 lg:col-span-2 lg:h-full">
    <img className=''
      src={room2}
      alt="contact us image"
      className="absolute top-2 inset-0 h-full w-full object-cover"
    />
  </div>
    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          ...
          <a href="#" className="block text-2xl font-medium overflow-hidden  hover:opacity-75 sm:text-3xl">
            7617231365
          </a>
        </p>
