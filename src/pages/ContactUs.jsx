...
export const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('serviceid', 'template_duyypb6', form.current, {
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="#fff">
        <path d="M12,2C6.48,2,2,6.48,2,12c0,5.52,3.58,10,8,10h0c1.55,0,3.05-0.45,4.32-1.3l4.96,1.65c0.3,0.1,0.62,0.05,0.88-0.15 c0.58-0.38,0.89-1.06,0.81-1.73l-1.35-7.87C21.95,6.18,18.22,2,14,2H12z M18.3,15.2c-0.16,0.09-0.91,0.54-1.06,0.59 c-0.14,0.05-0.25,0.08-0.35-0.06c-0.1-0.14-0.58-0.89-0.7-1.09c-0.12-0.2-0.25-0.16-0.37-0.15c-0.12,0.01-0.69,0.26-1.05,0.4 c-0.35,0.14-0.62,0.25-0.85,0.21c-0.24-0.04-0.53-0.29-0.87-0.84c-0.34-0.55-0.49-1.19-0.55-1.49c-0.06-0.3-0.03-0.49,0.05-0.66 c0.08-0.16,0.22-0.3,0.35-0.44c0.13-0.13,0.28-0.27,0.42-0.42c0.14-0.15,0.17-0.3,0.19-0.42c0.03-0.12,0.02-0.27-0.08-0.4 c-0.1-0.13-0.28-0.27-0.47-0.36c-0.19-0.09-0.42-0.18-0.68-0.09c-0.26,0.09-0.95,0.42-1.44,1.02c-0.49,0.6-0.75,1.23-0.87,1.49 c-0.12,0.26-0.33,0.48-0.61,0.61c-0.27,0.14-0.7,0.26-1.06,0.22c-0.36-0.05-0.71-0.25-1.01-0.48c-0.3-0.23-0.54-0.52-0.73-0.85 c-0.19-0.34-0.34-0.72-0.41-1.11c-0.07-0.39-0.08-0.78,0.01-1.11c0.09-0.33,0.28-0.62,0.51-0.87c0.23-0.25,0.53-0.47,0.84-0.63 c0.32-0.17,0.68-0.29,1.07-0.26c0.38,0.03,0.69,0.19,1,0.37c0.31,0.18,0.57,0.39,0.81,0.58c0.24,0.18,0.44,0.36,0.63,0.5 c0.18,0.14,0.34,0.27,0.5,0.38c0.15,0.11,0.29,0.21,0.43,0.31c0.14,0.09,0.3,0.17,0.5,0.27c0.2,0.1,0.46,0.21,0.74,0.3 c0.28,0.09,0.57,0.16,0.9,0.1c0.33-0.06,0.74-0.24,1.19-0.57c0.45-0.34,1.01-0.83,1.34-1.41c0.32-0.58,0.49-1.24,0.53-1.49 c0.04-0.25,0.04-0.51-0.02-0.74c-0.06-0.23-0.19-0.43-0.36-0.61c-0.17-0.18-0.37-0.33-0.58-0.45c-0.21-0.12-0.43-0.22-0.67-0.28 c-0.24-0.07-0.5-0.13-0.79-0.1c-0.28,0.03-0.55,0.16-0.79,0.33c-0.24,0.17-0.47,0.36-0.67,0.57c-0.2,0.21-0.39,0.42-0.55,0.62 c-0.16,0.2-0.29,0.36-0.41,0.5c-0.12,0.14-0.21,0.27-0.31,0.41c-0.09,0.14-0.18,0.26-0.3,0.4c-0.11,0.14-0.24,0.3-0.39,0.49 c-0.15,0.18-0.32,0.4-0.51,0.63c-0.19,0.24-0.41,0.51-0.65,0.8c-0.24,0.29-0.51,0.6-0.8,0.93c-0.29,0.33-0.59,0.68-0.93,1.05 c-0.34,0.37-0.7,0.74-1.11,1.13c-0.4,0.39-0.88,0.78-1.46,1.23c-0.58,0.45-1.31,0.98-2.06,1.39c-0.75,0.41-1.57,0.71-2.3,0.88 c-0.73,0.17-1.36,0.22-1.82,0.24c-0.2,0.01-0.37,0.03-0.53,0.04l-0.11,0.01C12.34,15.16,12.17,15.18,12,15.2L12,15.2z"/>
    </svg>
</a>
            ...
            <form ref={form} onSubmit={sendEmail}>
                <div className="grid sm:grid-cols-2 gap-8">
                    <div className="relative flex items-center">
                        <input type="text" placeholder="First Name" required name="from_first_name"
                    ...
                    <div className="relative flex items-center">
                        <input type="number" placeholder="Phone No." required name='from_phone_no'
                    ...
                    <div className="relative flex items-center sm:col-span-2">
                        <textarea placeholder="Write Message" required name='message'
