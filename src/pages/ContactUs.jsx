...
export const ContactUs = () => {
  ...
  return (
    ...
    <div className="text-center px-6">
        ...
        <p className="text-sm text-black font-playfair font-bold mt-4  ">Need help? We got you!!</p>
    </div>

    <div className="grid font-maven lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
        ...
        <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <ul className="mt-16 space-y-8">
                ...
                <li className="flex items-center justify-between">
                    ...
                    <a href="javascript:void(0)" className="text-white text-sm  ml-4">
                    <span className='font-semibold' >Address:</span> Haldoni mod Jalpura,nearby Saini Hospital Infront of GAIL India. 
                    </a>
                </li>
            </ul>
    ...
    <FaFacebook className=' text-blue-800 text-4xl  text-center rounded-full bg-black border-2 border-blue-800' />
    </a>
                </li>
                <li className="bg-gray-800 hover:bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
    ...
    <PiInstagramLogoFill className=' text-pink-400 text-4xl  text-center rounded-full bg-black border-2 border-pink-400'/>
    </a>
                </li>
            </ul>
        </div>
